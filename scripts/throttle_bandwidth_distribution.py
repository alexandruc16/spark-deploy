...
def generate(port, hosts distribution, filename):
    ...
    for pair in itertools.permutations(hosts, 2):
        ...
        print >> f, "%s:%s:%f" % (pair[0], pair[1], bandwidth_value)
...
def main():
    parser = argparse.ArgumentParser(description="Throttle cluster bandwidth "
                                     ...
                                     "./throttle-bandwidth-distribution -p 2345 --hosts 10.10.10.10 10.10.10.11 --distribution 60 150 260 380 650 -i 1000")
