...
val tables = new Tables(sqlContext, "/opt/tpcds-kit/tools", 32)
// Generate data.
tables.genData("hdfs:///tpcds", "parquet", true, false, false, false, false)
// Create metastore tables in a specified database for your data.
// After the table is created, automatically switch to the created database "sparktest"
tables.createExternalTables("hdfs:///tpcds", "parquet", "finaltest", false)
